...
- [COMMANDS](#commands)
  ...
  - [SERVER QUERY](#server-query)
    - [MODE](#mode)
      - [FORMAT](#format-16)
      - [Numerics](#numerics-12)
  - [SENDING MESSAGES](#sending-messages)
    - [PRIVMSG](#privmsg)
      - [FORMAT](#format-17)
      - [NUMERICS](#numerics-13)
      - [Numerics](#numerics-14)
    - [PART](#part-1)
      - [FORMAT](#format-18)
      - [Numerics](#numerics-15)
    - [TOPIC](#topic-1)
      - [FORMAT](#format-19)
      - [Numerics](#numerics-16)
    - [NAMES](#names-1)
      - [FORMAT](#format-20)
      - [Numerics](#numerics-17)
    - [LIST](#list-1)
      - [FORMAT](#format-21)
      - [Numerics](#numerics-18)
    - [INVITE](#invite-1)
      - [FORMAT](#format-22)
      - [Numerics](#numerics-19)
    - [KICK](#kick-1)
      - [FORMAT](#format-23)
      - [Numerics](#numerics-20)
  - [SERVER QUERY](#server-query-1)
    - [MODE](#mode-1)
      - [FORMAT](#format-24)
      - [Numerics](#numerics-21)
